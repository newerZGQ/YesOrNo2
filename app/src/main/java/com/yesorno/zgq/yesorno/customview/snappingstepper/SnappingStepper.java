package com.yesorno.zgq.yesorno.customview.snappingstepper;
...
public class SnappingStepper extends RelativeLayout implements View.OnTouchListener, ValueAnimator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
    ...
    private void initViews(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            int modeValue = a.getInt(R.styleable.SnappingStepper_snappingstepper_mode, Mode.AUTO.getValue());
            mode = Mode.valueOf(modeValue);
            minValue = a.getInt(R.styleable.SnappingStepper_snappingstepper_min, minValue);
            maxValue = a.getInt(R.styleable.SnappingStepper_snappingstepper_max, maxValue);
