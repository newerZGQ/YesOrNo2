 ...
 * Created by 37902 on 2016/3/27.
 */
public class YesOrNoView extends View {
    ...
    public YesOrNoView(Context context) {
        super(context);
    }

    public YesOrNoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        itemColorDef = getResources().getColor(R.color.colorPrimary);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.YesOrNoView);
        itemCountInt = typedArray.getInt(R.styleable.YesOrNoView_item_count, itemCountIntDef);
        firstItemTitle = typedArray.getString(R.styleable.YesOrNoView_first_item_title);
